...
export function AboutHeroSection() {
  return (
    <GridContainer as="section">
      <DynamicShiftText
        as="h1"
        className="col-span-4 max-w-[1038px] pt-[83px] font-sans text-[40px] leading-[1.1] font-light tracking-[-2px] text-align-text lg:col-span-3 lg:col-start-2 lg:max-w-none lg:text-[64px]"
      >
