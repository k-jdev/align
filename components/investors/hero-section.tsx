  ...
  return (
    <section className="w-full bg-align-bg">
      <GridContainer cols={8} className="pt-[83px] pb-12">
        ...
        <h1 className="col-span-8 mt-20 font-sans text-[40px] leading-[1.1] font-light tracking-[-2px] text-align-text md:mt-36 lg:col-span-3 lg:col-start-3 lg:text-[48px]">
